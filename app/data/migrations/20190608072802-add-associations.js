module.exports = {
  ...
  down: queryInterface =>
    queryInterface.sequelize.transaction(transaction =>
      Promise.all([
        queryInterface.removeColumn('users', 'league_id', { transaction }),
        ...
        queryInterface.removeColumn('leagues', 'creator_id', { transaction }),
        ...
        queryInterface.removeColumn('seasons', 'gameweek_id', { transaction })
      ])
    )
};
